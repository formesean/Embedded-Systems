...
;; *************** function _main *****************
;; Defined at:
;;		line 39 in file "D:\Embedded-Systems\Practice\Sync TX and RX\MPLAB\tx.c"
...
psect	maintext,global,class=CODE,delta=2,split=1
	file	"D:\Embedded-Systems\Practice\Sync TX and RX\MPLAB\tx.c"
	line	39
global __pmaintext
...
;tx.c: 45: CSRC = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	bsf	(1223/8)^080h,(1223)&7	;volatile
	line	46
...
l537:	
;tx.c: 53: TRISC7 = 0;
	bcf	(1087/8)^080h,(1087)&7	;volatile
	goto	l539
	line	55
;tx.c: 55: while (1)
...
;tx.c: 56: {
;tx.c: 58: if (!TXIE)
	btfsc	(1124/8)^080h,(1124)&7	;volatile
	goto	u51
	goto	u50
u51:
	goto	l539
...
;; *************** function _delay *****************
;; Defined at:
;;		line 16 in file "D:\Embedded-Systems\Practice\Sync TX and RX\MPLAB\tx.c"
;; Parameters:    Size  Location     Type
;;  num             2    4[COMMON] int 
;; Auto vars:     Size  Location     Type
...
;tx.c: 18: int flags = 0;
	...
	clrf	(delay@flags+1)
	line	20
;tx.c: 20: while (flags < num)
	goto	l31
	
l32:	
	line	22
;tx.c: 21: {
;tx.c: 22: if (count_flag)
...
;; *************** function _ISR *****************
;; Defined at:
;;		line 30 in file "D:\Embedded-Systems\Practice\Sync TX and RX\MPLAB\tx.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
